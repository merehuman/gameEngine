...
#ifndef GOOGLE_PROTOBUF_INCLUDED_FontData_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_FontData_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:FontData_proto) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR FontData_proto(
  ...
  FontData_proto* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 protected:
  explicit FontData_proto(::google::protobuf::Arena* arena);
  FontData_proto(::google::protobuf::Arena* arena, const FontData_proto& from);
  FontData_proto(::google::protobuf::Arena* arena, FontData_proto&& from) noexcept
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::FontEntry_proto>* mutable_pofontentry();

  private:
  const ::google::protobuf::RepeatedPtrField<::FontEntry_proto>& _internal_pofontentry() const;
  ::google::protobuf::RepeatedPtrField<::FontEntry_proto>* _internal_mutable_pofontentry();
  public:
...
inline PROTOBUF_ALWAYS_INLINE void FontData_proto::set_pversion(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline std::string* FontData_proto::mutable_pversion() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* FontData_proto::_internal_mutable_pversion() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.pversion_.Mutable( GetArena());
}
inline std::string* FontData_proto::release_pversion() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void FontData_proto::set_allocated_pversion(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
inline ::google::protobuf::RepeatedPtrField<::FontEntry_proto>* FontData_proto::mutable_pofontentry()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::FontEntry_proto* FontData_proto::add_pofontentry() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::google::protobuf::RepeatedPtrField<::FontEntry_proto>*
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_FontData_2eproto_2epb_2eh
